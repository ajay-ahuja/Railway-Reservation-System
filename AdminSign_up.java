...
public class AdminSign_up extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cmbStateSelect.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Uttarakhand", "Uttar Pradesh", "West Bengal", "Delhi", "Andaman & Nicobar Is.", "Chandigarh", "Dadra & Nagar Haveli","Andhra Pradesh", "Arunachal Pradesh", "Assam", "Bihar", "Chhattisgarh", "Goa", "Gujarat", "Haryana", "Himachal Pradesh", "Jammu & Kashmir", "Jharkhand", "Karnataka", "Kerala", "Madhya Pradesh", "Maharashtra", "Manipur", "Meghalay", "Mizoram", "Nagaland", "Odisha", "Punjab", "Rajasthan", "Sikkim", "Tamil Nadu", "Telangana", "Tripura","Daman & Diu", "Lakshdweep", "Puducherry" }));
